...
const config={
    ...
    loginNgoUrl:String(import.meta.env.VITE_LOGIN_NGO_URL),
    registerUrl:String(import.meta.env.VITE_REGISTER_URL),
    registerNgoUrl:String(import.meta.env.VITE_REGISTER_NGO_URL),
    ...
    getNgoList:String(import.meta.env.VITE_GET_NGO_LIST),
    ...
    connectedUser:String(import.meta.env.VITE_CONNECTED_USERS)
}
